...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('erp/assets/hillside-favicon.svg') }}?v={{ filemtime(public_path('erp/assets/hillside-favicon.svg')) }}" type="image/svg+xml">
        <link rel="alternate icon" href="{{ asset('erp/assets/hillside-icon-32.png') }}" type="image/png" sizes="32x32">
